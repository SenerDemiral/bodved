    ...
    class Program
    {
        ...
        private static void popTable()
        {
            Db.Transact(() =>
            {
                ...
                var pn16 = new BDB.PP() { Ad = "İlyas ERBEM" };
